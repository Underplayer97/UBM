...
public class ubmRegistries 
{
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) 
	{
		...
		(
				...
				//Armor
				UbmItems.ancient_helmet = new ArmorItem(UbmArmorMaterials.head, EquipmentSlotType.HEAD, new Item.Properties().group(Ubm)).setRegistryName(location("ancient_helmet")),
				UbmItems.ancient_chestplate = new ArmorItem(UbmArmorMaterials.chest, EquipmentSlotType.CHEST, new Item.Properties().group(Ubm)).setRegistryName(location("ancient_chestplate")),
			    UbmItems.ancient_leggings = new ArmorItem(UbmArmorMaterials.leg, EquipmentSlotType.LEGS, new Item.Properties().group(Ubm)).setRegistryName(location("ancient_leggings")),
			    UbmItems.ancient_boots = new ArmorItem(UbmArmorMaterials.boots, EquipmentSlotType.FEET, new Item.Properties().group(Ubm)).setRegistryName(location("ancient_boots"))
